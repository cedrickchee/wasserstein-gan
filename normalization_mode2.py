...
class BatchNormalizationMode2(Layer):
    ...
    Note: This is clone from the old Keras 1.2.2 layer.
    ...
    def __init__(self, epsilon=1e-3, mode=0, axis=-1, momentum=0.99,
        ...
        super(BatchNormalizationMode2, self).__init__(**kwargs)
    ...
    def get_config(self):
        ...
        base_config = super(BatchNormalizationMode2, self).get_config()
